...
import { deleteWorkspacesInFirebase } from '@/lib/server-action/action';
...
const QuillEditor: React.FC<QuillEditorProps> = ({
  ...
  const restoreFileHandler = async () => {
    if (dirType === 'file') {
      ...
      dispatch({
        ...
        payload: { file: { inTash: '' }, fileId, folderId, workspaceId },
      });
    ...
    if (dirType === 'folder') {
      ...
      dispatch({
        ...
        payload: { folder: { inTash: '' }, folderId: fileId, workspaceId },
      });
  ...
  const deleteFileHandler = async () => {
    if (dirType === 'file') {
      ...
      await deleteWorkspacesInFirebase([fileId])
    }
    if (dirType === 'folder') {
      ...
      const allRooms = await getIdsByFolderId(fileId)
      ...
      <div className="relative">
        {details.inTash && (
          ...
          >
            ...
            <span className="text-sm text-white">{details.inTash}</span>
          </article>
        )}
        <div
          className="flex 
